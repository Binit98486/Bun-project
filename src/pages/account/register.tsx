    ...
    return (
        <>
            ...
            <div className="flex  mt-20 justify-center  ">
                ...
                <form onSubmit={handleSubmit(onSubmit)} className="flex flex-col justify-center gap-2 p-7 w-[400px]">
                    ...
                    <div className="flex flex-col">
                        <div>Email</div>
                        <input id="email" type="email" pattern="[a-z0-9._%+-]+@[a-z0-9.-]+\.[a-z]{2,}$" className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm 
      ...
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500"
                    ...
                    <div className="flex flex-col">
                        <div>Phone</div>
                        <input className="mt-1 block w-full px-3 py-2 bg-white border border-slate-300 rounded-md text-sm shadow-sm 
      focus:outline-none focus:border-sky-500 focus:ring-1 focus:ring-sky-500
      disabled:bg-slate-50 disabled:text-slate-500 disabled:border-slate-200 disabled:shadow-none
      invalid:border-pink-500 invalid:text-pink-600
      focus:invalid:border-pink-500 focus:invalid:ring-pink-500" type="number"
                            ...
                            onInput={(e: any) => {
                                e.target.value = Math.max(0, parseInt(e.target.value) || 0).toString().slice(0, 13);
                            }}
                            {...register('phone')}
                        />
                    </div>
